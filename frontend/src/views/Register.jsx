    ...
    <form onSubmit={handleForm} className='col-10 col-sm-6 col-md-3 m-auto mt-5'>
      ...
      <div className='form-group mt-1 '>
        ...
        >
          ...
          <option value='Empleado'>Full Stack Developer</option>
          <option value='Supervisor de Compras'>Frontend Developer</option>
          <option value='Supervisor de Inventarios'>Backend Developer</option>
          <option value='Supervisor de Ventas'>Backend Developer</option>         
        </select>
      </div>
      <div className='form-group mt-1'>
        ...
        >
          ...
          <option value='Español'>JavaScript</option>
          <option value='Inglés'>Python</option>
        </select>
      </div>
